...
class CassandraHook(BaseHook, LoggingMixin):
    ...
    def __init__(self, cassandra_conn_id='cassandra_default'):
        ...
        lb_policy = self.get_policy(policy_name, policy_args)
        if lb_policy:
    ...
    @staticmethod
    def get_policy(policy_name, policy_args):
        policies = {
        ...
        if policy_name == 'TokenAwarePolicy':
            ...
            if child_policy_name not in allowed_child_policies:
                ...
                child_policy = CassandraHook.get_policy(child_policy_name, child_policy_args)
